...
- ssh into the server
    - For Mac and Linux: `ssh root@jesseandrade.codes`
    - For Windows: Set up a new PuTTY session
        ...
        - **Session**
            ...
            - Click Save
- create user
    - `useradd -m -s /bin/bash -g users -G sudo jandrade14`
    - replace jandrade14 with your own
- create password
    - `passwd jandrade14`
- Move .ssh key file
    - `cp -r .ssh /home/jandrade14`
- change ownership of the .ssh directory
    - `cd /home/jandrade14`
    - `chown -R jandrade14:users .ssh/`


- Test Changes
    - `exit`
    - Mac/Linux: `ssh jandrade14@jesseandrade.codes`
    - Windows:
        - **Session**
            - Click pwp
            - Click Load
...
- reboot
    - `sudo reboot`
- ssh back in
- `ssh jandrade14@jesseandrade.codes`
...
- create a directory for your deployment
    - `sudo mkdir /var/www/jesseandrade.codes/html`
- fix permissions
    - `sudo chown -R $USER:users /var/www/jesseandrade.codes/html`
...
- `sudo vim /etc/nginx/sites-available/jesseandrade.codes`
...
server {
    ...
    root /var/www/jesseandrade.codes/html;
    index index.html index.htm index.nginx-debian.html;

    server_name jesseandrade.codes www.jesseandrade.codes;
...
- create a symlink to the sites-enabled directory
    - `sudo ln -s /etc/nginx/sites-available/jesseandrade.codes /etc/nginx/sites-enabled/`
...
- Create a new ssh key on your server in the .ssh directory
    - `ssh-keygen -t ed25519 -C  "github Deploy Key" -f /home/jandrade14/.ssh/github_deploy_key`
    - Don't enter a passphrase
        - hit enter twice
- Copy the public key into your authorized keys file
    - `cat /home/jandrade14/.ssh/github_deploy_key.pub >> /home/jandrade14/.ssh/authorized_keys`
...
- Copy the private key to your clipboard **(this is a very dangerous operation do not share this key with anyone )**
    ...
    - `cat /home/jandrade14/.ssh/github_deploy_key`
  ...
  deploy:
    ...
    steps:
      ...
      - name: Deploy to server
        run: |
         ssh-keyscan -H jesseandrade.codes >> ~/.ssh/known_hosts 
         scp -r ./dist/* jandrade14@jesseandrade.codes:/var/www/jesseandrade.codes/html
```
